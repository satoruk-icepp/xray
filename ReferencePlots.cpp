...
void ReferencePlots(){
  ...
  while(getline(ifLEICA, strLEICA)) {
	...
	Float_t YPos;
	Float_t ZPos;
	sscanf(strLEICA.data(), "%f\t%f\t%f", &XPos, &YPos, &ZPos);
	grLEICA->SetPoint(grLEICA->GetN(),XPos,YPos,ZPos);
  ...
  while(getline(ifFARO, strFARO)) {
	...
	Float_t YPos;
	Float_t ZPos;
	sscanf(strFARO.data(), "%f\t%f\t%f", &XPos, &YPos, &ZPos);
	grFARO->SetPoint(grFARO->GetN(),XPos,YPos,ZPos);
  ...
  grLEICA->SetMaximum(1500);
  grLEICA->SetMinimum(-1500);
  grLEICA->GetXaxis()->SetLimits(-1500,1500);
  grLEICA->GetYaxis()->SetLimits(-1500,1500);
  grLEICA->SetMarkerStyle(22);
  ...
  grFARO->SetMaximum(1500);
  grFARO->SetMinimum(-1500);
  grFARO->GetXaxis()->SetLimits(-1500,1500);
  grFARO->GetYaxis()->SetLimits(-1500,1500);
  grFARO->SetMarkerStyle(22);
